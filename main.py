...
#Colors
mem_bg = "#101820"
mem_fg  =  "#F2AA4C"            # Same for rooms_bg
main_bg  =  "#303030"           #"#00203F"  # "#00539C"
main_fg  =  "#E8EAF6"           #"#ADEFD1"  # "#FFD662"
rooms_bg  =  "#06373A"
rooms_fg  =  "#F2AA4C"
bills_bg  =  "#606060"          #  bg = 606060
bills_fg  =  "#D6ED17"          # fg = D6ED17
# Functions
...
def add_member():
    ...
    #Membership ID Entry
    #Label(add_member_window, text = "    Enter Membership ID :", bg = mem_bg,font = "Corbel 14 bold", fg = mem_fg).grid(pady = 10,row = 7, sticky = "w")
    #ID_entry  =  (Entry(add_member_window, width = 15, font = "Consolas 14",textvariable = id_var).grid(pady = 10,row = 7, sticky = "e"))
    #First Name Entry
...
def delete_all_members():
    def delete_all():
        ...
        cur.execute(sql) 
        messagebox.showinfo("Delete all members","All members were deleted",parent = delete_all_window)
        db.commit()  
    ...
    delete_all_window.configure(bg = mem_bg)
    Label(delete_all_window, text = "   ╔═══════════╗", bg = mem_bg,font = "Corbel 20 bold", fg = mem_fg).grid(row = 1)
    Label(delete_all_window, text = "  Delete All Members",bg = mem_bg, fg = mem_fg, font = "Corbel 20 bold").grid(row = 2)
    Label(delete_all_window, text = "   ╚═══════════╝", bg = mem_bg,font = "Corbel 20 bold", fg = mem_fg).grid(row = 3)
...
def delete_by_ID():
    def delete_id():
        ...
        if membership_id != "":
            if (membership_id,) in temp_mid_list:
                sql = "delete from members WHERE membership_id  =  %s" % membership_id
                cur.execute(sql) 
                db.commit()
                messagebox.showinfo("Delete member","Member with membership ID %s was deleted" % membership_id ,parent = delete_by_id_window)
                clear_cmd()
            else:
                messagebox.showerror("Delete Member","%s is not a valid Membership ID or member with %s as membership ID does not exist" % (membership_id,membership_id), parent = delete_by_id_window)
        else:
            messagebox.showwarning("Delete Member","Enter Membership ID",parent = delete_by_id_window)
    def clear_cmd():
    ...
    delete_by_id_window.title("Delete Member by Membership ID")
    delete_by_id_window.configure(bg = mem_bg)
    Label(delete_by_id_window, text = "   ╔═══════════╗", bg = mem_bg,font = "Corbel 20 bold", fg = mem_fg).grid(row = 1)
    Label(delete_by_id_window, text = "  Delete By Membership ID",bg = mem_bg, fg = mem_fg, font = "Corbel 20 bold").grid(row = 2)
    Label(delete_by_id_window, text = "   ╚═══════════╝", bg = mem_bg,font = "Corbel 20 bold", fg = mem_fg).grid(row = 3)
    Label(delete_by_id_window, text = "", bg = mem_bg).grid(row = 4)
    Label(delete_by_id_window, text = "    Enter Membership ID :", bg = mem_bg,font = "Corbel 14 bold", fg = mem_fg).grid(row = 5, sticky = "w")
    #
    id_entry  =  (Entry(delete_by_id_window, width = 15, font = "Consolas 14",textvariable = membership_id_var).grid(row = 5, sticky = "e"))
    #
    Label(delete_by_id_window, text = " ", bg = mem_bg, font = "Corbel 20 bold").grid(row = 6)
    Label(delete_by_id_window, text = " ", bg = mem_bg, font = "Corbel 20 bold").grid(row = 7)
    ...
    Label(delete_by_id_window, text = " ", bg = mem_bg).grid(row = 8)
...
def delete_by_phone_number():
    def delete_phone_number():
        cur.execute("select phone_no from members")
        temp_ph_no_list = cur.fetchall()
        phone_number = phone_number_var.get()
        phone_number = phone_number.strip()
        if phone_number != "":
            if (phone_number,) in temp_ph_no_list:
                sql = "delete from members WHERE phone_no  =  '%s'" % phone_number
                cur.execute(sql) 
                db.commit()
                messagebox.showinfo("Delete Member","Member with phone number %s was deleted" % phone_number, parent = delete_by_phone_number_window)
                clear_cmd()
            else:
                messagebox.showinfo("Delete member","Member with Phone Number %s does not exit" % phone_number ,parent = delete_by_phone_number_window)
        else:
            messagebox.showinfo("Delete member","Enter a Phone Number" ,parent = delete_by_phone_number_window)
    ...
    delete_by_phone_number_window.title("Delete Member by Phone Number")
    delete_by_phone_number_window.configure(bg = mem_bg)
    Label(delete_by_phone_number_window, text = "   ╔═══════════╗", bg = mem_bg,font = "Corbel 20 bold", fg = mem_fg).grid(row = 1)
    Label(delete_by_phone_number_window, text = "  Delete By Phone Number",bg = mem_bg, fg = mem_fg, font = "Corbel 20 bold").grid(row = 2)
    Label(delete_by_phone_number_window, text = "   ╚═══════════╝", bg = mem_bg,font = "Corbel 20 bold", fg = mem_fg).grid(row = 3)
    Label(delete_by_phone_number_window, text = "", bg = mem_bg).grid(row = 4)
    Label(delete_by_phone_number_window, text = "    Enter Phone Number :", bg = mem_bg,font = "Corbel 14 bold", fg = mem_fg).grid(row = 5, sticky = "w")
    #
    ...
    #
    Label(delete_by_phone_number_window, text = " ", bg = mem_bg, font = "Corbel 20 bold").grid(row = 6)
    Label(delete_by_phone_number_window, text = " ", bg = mem_bg, font = "Corbel 20 bold").grid(row = 7)
    ...
    Label(delete_by_phone_number_window, text = " ", bg = mem_bg).grid(row = 8)
...
def delete_by_email():
    def delete_email():
        ...
        temp_email_list = cur.fetchall()
        if email !="":
            if (email,) in temp_email_list:
                sql = "delete from members WHERE Email_ID  =  '%s'" % email
                cur.execute(sql)                                                                                                          
                db.commit()
                messagebox.showinfo("Delete Member","Member with email ID %s was deleted" % email, parent = delete_by_email_window)
            else:
                messagebox.showinfo("Delete Member","Member with email ID %s does not exist or is invalid" % email, parent = delete_by_email_window)
        else:
            messagebox.showinfo("Delete Member","Enter a Email ID", parent = delete_by_email_window)
    ...
    delete_by_email_window.configure(bg = mem_bg)
    Label(delete_by_email_window, text = "   ╔═══════════╗", bg = mem_bg,font = "Corbel 20 bold", fg = mem_fg).grid(row = 1)
    Label(delete_by_email_window, text = "  Delete By Email ID",bg = mem_bg, fg = mem_fg, font = "Corbel 20 bold").grid(row = 2)
    Label(delete_by_email_window, text = "   ╚═══════════╝", bg = mem_bg,font = "Corbel 20 bold", fg = mem_fg).grid(row = 3)
    Label(delete_by_email_window, text = "", bg = mem_bg).grid(row = 4)
    Label(delete_by_email_window, text = "    Enter Email ID :", bg = mem_bg,font = "Corbel 14 bold", fg = mem_fg).grid(row = 5, sticky = "w")
    #
    email_entry  =  (Entry(delete_by_email_window, width = 15, font = "Consolas 14",textvariable = email_var).grid(row = 5, sticky = "e"))
    #
    Label(delete_by_email_window, text = " ", bg = mem_bg, font = "Corbel 20 bold").grid(row = 6)
    Label(delete_by_email_window, text = " ", bg = mem_bg, font = "Corbel 20 bold").grid(row = 7)
    ...
    Label(delete_by_email_window, text = " ", bg = mem_bg).grid(row = 8)
...
def delete_member_options():
    ...
    delete_member_options_window.configure(bg = mem_bg)
    Label(delete_member_options_window, text = " ╔══════════╗", bg = mem_bg,font = "Corbel 20 bold", fg = mem_fg, padx = 20).grid(row = 1)
    Label(delete_member_options_window, text = "Delete Member", bg = mem_bg,fg = mem_fg, font = "Corbel 20 bold", padx = 90).grid(row = 2)
    Label(delete_member_options_window, text = " ╚══════════╝", bg = mem_bg,font = "Corbel 20 bold", fg = mem_fg).grid(row = 3)
    Label(delete_member_options_window, text = "", bg = mem_bg).grid(row = 4)
    Button(delete_member_options_window, text = "Delete All Members", width = 20,height = 2, command = delete_all_members, bd = 5).grid(row = 5)
    Label(delete_member_options_window, text = "", bg = mem_bg).grid(row = 6)
    Button(delete_member_options_window, text = "Delete By ID", width = 20,height = 2, command = delete_by_ID, bd = 5).grid(row = 7)
    Label(delete_member_options_window, text = "", bg = mem_bg).grid(row = 8)
    ...
    Label(delete_member_options_window, text = "", bg = mem_bg).grid(row = 10)
    Button(delete_member_options_window, text = "Delete By Email ID", width = 20,height = 2, command = delete_by_email, bd = 5).grid(row = 11)
    Label(delete_member_options_window, text = "", bg = mem_bg).grid(row = 12)
...
def update_email_window():
    def update_email_id():
        ...
        if mem_id and email_id != "":
            ...
            messagebox.showwarning("Update Member Info","Enter a valid Membership ID and a Valid Email ID", parent = update_email_id_window)
...
def update_points_window():
    def update_email_id():
        ...
        if mem_id != "":
            ...
            messagebox.showerror("Update Member Info","Enter a valid Membershi ID", parent = update_points_window)    
    def clear_cmd():
        mem_id_var.set("")
        points_add_var.set("")
    #Entry String declaration
...
def members_window():
    ...
    for row in myresult:
        tree.insert("", END, values = row)
    # Buttons
    Button(members_page, text = "Search Member", width = 15, height = 2,command = display_members_options, bd = 5).pack(side = LEFT,padx = 10,pady = 15)
    Button(members_page, text = "Add Member", width = 15, height = 2,command = add_member, bd = 5).pack(side = LEFT,padx = 10,pady = 15)
    Button(members_page, text = "Delete Member", width = 15, height = 2, command = delete_member_options, bd = 5).pack(side = LEFT,padx = 10,pady = 15)
    Button(members_page, text = "Update Member", width = 15, height = 2, command = update_member_options, bd = 5).pack(side = LEFT,padx = 10,pady = 15)
    Button(members_page, text = "Close Window", font = "Corbel 10", width = 15, height = 2,bd = 5, command = members_page.destroy).pack(side = LEFT,padx = 10,pady = 15)
...
def display_all_rooms():
    ...
    #Setting the Table
    tree  =  ttk.Treeview(all_rooms_window, column = ("c1", "c2", "c3","c4","c5","c6"), show = 'headings')
    tree.column("#1", anchor = CENTER,width = 60)
    tree.heading("#1", text = "Mem. ID")
    tree.column("#2", anchor = "e",width = 130)
    tree.heading("#2", text = "First Name")
...
def clear_cmd_rooms():
       ...
       def search_rooms():
              ...
              myresult  =  cur.fetchall()
              #Showing Result
              result  =  Label(search_result, text = tabulate(myresult, headers = ['Membership ID','First name','Last name','Booking amount','Room no'],tablefmt = 'fancy_grid'), bg = rooms_bg, fg = mem_fg, font = "Consolas 12 ").grid(padx = 20,row = 5)
...
def check_out_cmd():
       ...
       def update_vacancy():
            ...
            if vac != "":
                ...
                db.commit()
                messagebox.showinfo("Updated Room Status and Bill Generated Successfully!","Room occupancy status was updated!", parent = update_vac_window)
            else:
...
def search_bill_by_mid():
    def search_bill_mid():
        ...
        try:
            ...
            messagebox.showerror("Search Bill","Invalid bill number entered" ,parent = search_bill_by_mid_window)
    def clear_cmd():
        mid_var.set("")
    mid_var = StringVar()
